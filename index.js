...
function renderMovieList(data) {
  ...
  dataPanelCard.innerHTML = rawHTML
}
...
paginator.addEventListener('click', function onPaginatorClicked(event) {
  ...
  if (dataPanelCard.innerHTML === "") {
    renderMovieListList(getMoviesByPage(CURRENT_PAGE))
  }
  else if (dataPanelList.innerHTML === "") {
...
// listen to list card button
ChangeMode.addEventListener('click', function onButtonClicked(event) {
  if (event.target.matches('.fa-th')) {
    dataPanelList.innerHTML = ''
    renderMovieList(getMoviesByPage(CURRENT_PAGE))
  }
  else if (event.target.matches('.fa-bars')) {
    dataPanelCard.innerHTML = ''
    renderMovieListList(getMoviesByPage(CURRENT_PAGE))
  }
